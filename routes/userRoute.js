...
const { userValidateSignup, userUpdateValidation, resetPassValidate } = require('../utils/validation');
...
Router.post('/reset-password/:id', passwordAuth, resetPassValidate,  userController.retrieve);
